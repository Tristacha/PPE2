<?php 
session_start();
if(!isset($_SESSION['prixV'])){$_SESSION['prixV'] = 0;}
    ...
    <body id="main-homepage">
		...
		<center><div class="container-contact100" style="padding-bottom: 1px; ">
					...
					<form ation="" method="POST">
							<span class="contact100-form-title" style="font-family: calibri; font-size: 58px; background-color: orange; border-radius: 3px; width: 100%; color: black;"><br />
								Récapitulatif
							</span>
							<div style=" width: 450px; color:white;"> ***</div><br />

							<div class="wrap-input100 input100-input bg1" >
								<span class="label-input100" style="font-family: calibri; font-size:28px; "><?php echo $_SESSION['nom'].' '.$_SESSION['prenom'];?></span>
								
							</div>

							<div class="wrap-input100 input100-input bg1">
								<span class="label-input100" style="font-family: calibri; font-size:16px; "> Numero de telephone</span><br />
								<input type="text" value="<?php echo $_SESSION['tel'];?>" style="font-family: calibri; font-size:28px;  border: none; text-align: center;">
							</div>

							<div class="wrap-input100 input100-input bg1">
								<span class="label-input100" style="font-family: calibri; font-size:16px; ">Adresse Mail</span><br />
								<input type="text" value="<?php echo $_SESSION['mail'];?>" style="font-family: calibri; font-size:28px; border: none; text-align: center;" ">
								
							</div>

							<div class="wrap-input100 input100-input bg1">
								<span class="label-input100" style="font-family: calibri; font-size:16px; ">Adresse de facturation *</span>
								<input class="input100" type="text" style="font-family: calibri; font-size:28px; " name="facturation" placeholder="Adresse de facturation" /required>
							</div>
					</div>
				</div></center>
		...
		<center><div class="container-contact100" style="padding-bottom: 1px;">
					<div class="wrap-contact100">
							...
							<div style=" width: 450px; color:white;"> ***</div><br />
							<div class="wrap-input100 validate-input bg1" data-validate="Trajet" style=" font-family: calibri; font-size: 28px; width: 450px;  color: black; padding-bottom:10px;">
								<h4 style="font-family: calibri; font-size: 16px;">NOM TRAJET:</h4>
								<?php echo $_SESSION['nom_liaison']?>
							</div>

							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Distance" style=" font-family: calibri; font-size: 28px; width: 450px;  color: black; padding-bottom:10px;">
								<h4 style="font-family: calibri; font-size: 16px;">DISTANCE;</h4>
								<?php echo $res['Distance'];?>
							</div>

							<div class="wrap-input100 bg1 rs1-wrap-input100" style=" width: 450px;  color: black; padding-bottom:10px; font-family: calibri; font-size: 28px;">
								<h4 style="font-family: calibri; font-size: 16px;">HEURE:</h4>
								<?php echo $res['heure'];?>
							</div>

							<div class="wrap-input100 input100-select bg1" style=" width: 450px;  color: black; padding-bottom:10px; font-family: calibri; font-size: 28px; ">
								<h4 style="font-family: calibri; font-size: 16px;">date:</h4>
								<?php $date =  $res['date'];
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" style="width: 100%; background-color: white; border: 2px solid orange; ">
								<span class="label-input100" ><h5 style="font-family: calibri; font-size: 40px;" >Nombre de personne :</h5></span><br />

									<span class="label-input100" style="font-family: calibri; font-size: 18px;" >Adulte</span>
										<div class="wrap-input100 input100-input bg1" style=" width: 50%; border: 2px solid orange; font-family: calibri; font-size: 38px;">
											<span class="label-input100" style="font-family: calibri; font-size: 28px;"><?php echo $_SESSION['adulte'];?></span>
										</div>
							
								<span class="label-input100" style="font-family: calibri; font-size: 18px;">Junior</span>
									<div class="wrap-input100 input100-input bg1" style="width: 50%; border: 2px solid orange;">
											<span class="label-input100" style="font-family: calibri; font-size: 28px;"><?php echo $_SESSION['junior'];?></span>
										</div>
								<span class="label-input100" style="font-family: calibri; font-size: 18px;">Enfant</span>
									<div class="wrap-input100 input100-input bg1" style="width: 50%; border: 2px solid orange;">
											<span class="label-input100" style="font-family: calibri; font-size: 28px;"><?php echo $_SESSION['enfant'];?></span>
										</div>
							</div>
						</div>
					</div></center>
					...
					<div class="wrap-contact100" >
						<span class="label-input100"><h3 style="font-family: calibri; font-size: 38px;">Total</h3></span>
						<hr width="100%" color="black" size="5">
						<span class="label-input100"><h5 style="font-family: calibri; font-size: 28px;">Prix passager(s) : &nbsp; <?php echo $_SESSION['prix'].'€';?></h5></span><br />
						<span class="label-input100"><h5 style="font-family: calibri; font-size: 28px;">Prix véhicule(s): <?php echo $_SESSION['prixV'].'€';?></h5></span><br />
						<hr width="100%" color="black">
						<span class="label-input100"><h5 style="font-family: calibri; font-size: 28px;">Réduction: <?php echo $_SESSION['fid'].'%';?></h5></span>
						<span class="label-input100"><h5 style="font-family: calibri; font-size: 28px;">Sous Total : 
                                                              <?php if($_SESSION['fid'] == 100)
                                                                  {
                                                                    $red = 0.25;
						...
						<hr size="5" color="black"><br /><br />
							...
							<center><button class="button" name="payer" style="width: 300px; background-color: #16B84E; height: 50px; border:none;">
								<span style="font-size: 32px; color: white; font-family: calibri; ">
