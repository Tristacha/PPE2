                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div id="links">
                            <ul class="list-unstyled list-inline">
                                ...
                                <li><a href="Connexion.html"><span><i class="fa fa-lock"></i></span>Se connecter</a></li>
                                <li>
                                	<form>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown active"><a href="Horaires.html" class="btn btn-white">Horaires<span></span></a>		
                        </li>
            ...
            <div id="mySidenav" class="sidenav" >
                ...
                <div id="main-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        ...
                        <a href="Trajet.html" class="btn btn-black"  ><span><i class="fa fa-ship link-icon"></i></span>  Trajets<span></span></a>                      
                        
                        <a href="Horaires.html" class="btn btn-black active" ><span><i class="fa fa-clock-o link-icon"></i></span>  Horaires<span></span></a>
